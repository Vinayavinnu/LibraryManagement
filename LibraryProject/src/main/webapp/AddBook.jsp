...
%>
	...
	<form action="AddBook" onsubmit="return validate();" method="post">
	<div class="container">
	
	<p><b>Add Books to Library</b></p>
	...
	<hr>
		...
		<table>
			<tr>
				...
				<td><input type="text" placeholder="Book Name" name="bookName" id="bookName"></td>
				<td><span style="color:red" id="bookNameError">*</span></td>
			</tr>
			<tr>
				<td> <label for="author"><b>Author</b></label></td>
				<td><input type="text" placeholder="Author" name="author" id="author"></td>
				<td><span style="color:red" id="authorError">*</span></td>
			</tr>
			<tr>
			<tr>
				<td> <label for="language"><b>Language</b></label></td>
				<td><input type="text" placeholder="Language" name="language" id="language"></td>
				<td><span style="color:red" id="languageError">*</span></td>
			</tr>
			<tr>
				<td> <label for="publishYear"><b>Publish Year</b></label></td>
				<td><input type="text" placeholder="Publish Year" name="publishYear" id="publishYear"></td>
				<td><span style="color:red" id="publishYearError">*</span></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" class="registerbtn" name="Add" value="Add"></td>
			</tr>
		</table>
		</div>
	</form>
