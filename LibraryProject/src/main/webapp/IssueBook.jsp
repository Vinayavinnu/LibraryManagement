...
function validate(){
	...
	if (category=="")
	{
		document.getElementById("categoryError").innerHTML="Please select a book...";
	...
	if (userId=="")
	{
		document.getElementById("userIdError").innerHTML="Please select a user...";
...
%>
	<form action="IssueBook" onsubmit="return validate();" method="post">
	<div class="container">
		<table>
			<tr>
				...
				<td>
					<div class="dropdown">
							...
							%>
							<select class="dropbtn" id="category" name="category">
				...
				<td><span style="color:red" id="categoryError">*</span></td>
			</tr>
			...
			<tr>
				...
				<td>
						...
						<div class="dropdown">
							<%
							List<UserEntity> users = (List<UserEntity>) request.getAttribute("userlist");
							%>
							<select class="dropbtn" id="userId" name="userId">
							<div class="dropdown-content">
							<option value="">Select</option>
								<%
				...
				<td><span style="color:red" id="userIdError">*</span></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2"><input type="submit" class="registerbtn" name="Issue" value="Issue"></td>
			</tr>
		</table>
		</div>
	</form>
